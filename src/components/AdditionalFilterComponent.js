...
export default function AdditionalFilterComponent() {
  return (
    <div className='addition'>
      <div>
        <h4 className='addition-title'><strong>Cloud Cover:</strong></h4>
        <Slider tipFormatter={formatter} defaultValue={100}/>
      </div>
      <div>
        <h4 className='addition-title'><strong>Resolution:</strong></h4>
        <Slider range tipFormatter={formatm} defaultValue={[0,30]} min={0} max={30} step={0.5}/>
      </div>
      <div>
        <h4 className='addition-title'><strong>Off Nadir:</strong></h4>
